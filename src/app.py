...
if show_data:
    ...
    fig.add_trace(go.Scatter(x=data['dates'], y=data['prices'], name='Price (USD)'))
    fig.add_trace(go.Scatter(x=data['dates'], y=data['sma'], name='Small Moving Average (USD)'))
    fig.add_trace(go.Scatter(x=data['dates'], y=data['cma'], name='Comulative Moving Average (USD)'))
    fig.add_trace(go.Scatter(x=data['dates'], y=data['ema'], name='Exponential Moving Average (USD)'))
